...
if (typeof WebSocket === 'undefined') {
  console.error(`This probe needs Node 22+ for the built-in WebSocket. Current: ${process.version}`)
  console.error('Node 20 has no WebSocket global and no flag to enable one. Switch versions first:')
  console.error('  nvm use 22          # the repo also has an .nvmrc, so plain `nvm use` works')
  console.error('  node -v             # expect v22.x')
  console.error('  npm run probe')
  process.exit(1)
}
